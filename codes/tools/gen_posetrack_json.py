...
mat_dir = "/mnt/nas/nas4storm_disk1/xna-tsukamoto/posetrack2017/posetrack_data/annotations/{}" # '/path/to/posetrack_data/annotations/{}'
out_path = "/home/storm/projects/posetrack2017/renamed/posetrack_{}.json" # '/path/to/output/jsons/posetrack_{}.json'
...
if 1:  # `convert` the frames to standard format
    ...
    vid_indir = '/mnt/nas/nas4storm_disk1/xna-tsukamoto/posetrack2017/posetrack_data/images'
    vid_outdir = '/home/storm/projects/posetrack2017/renamed/images'
...
def _gen_image_structure(vname, frame_id, frame_data, vid_info, imid):
    ...
    if 'track_id' in vid_info:
        image['track_id'] = int(vid_info['track_id'])
